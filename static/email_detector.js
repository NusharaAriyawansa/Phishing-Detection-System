...
function displayResult(data) {
    ...
    // Set email info
    document.getElementById('resultSender').textContent = data.email.sender;
    document.getElementById('resultSubject').textContent = data.email.subject;
